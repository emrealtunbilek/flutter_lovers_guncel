...
class _EmailveSifreLoginPageState extends State<EmailveSifreLoginPage> {
  ...
  void _formSubmit() async {
    ...
    if (_formType == FormType.LogIn) {
      try {
        MyUser _girisYapanUser = await _userModel.signInWithEmailandPassword(_email, _sifre);
      ...
      try {
        MyUser _olusturulanUser = await _userModel.createUserWithEmailandPassword(_email, _sifre);
